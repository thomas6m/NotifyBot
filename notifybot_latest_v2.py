...
def send_via_sendmail(recipients: List[str], subject: str, body_html: str, 
                     ...
                     dry_run: bool = False, original_recipients_count: int = 0) -> bool:
    ...
    try:
        ...
        msg = create_email_message(recipients, final_subject, body_html, from_address, attachment_folder)
...
def send_email_batch(recipients: List[str], subject: str, body_html: str, 
                    ...
                    original_recipients_count: int = 0) -> None:
    ...
    for i in range(0, total_recipients, batch_size):
        ...
        # Send current batch
        if send_via_sendmail(batch, subject, body_html, from_address, attachment_folder, dry_run, original_recipients_count):
        ...
        # Note: In dry-run mode, we typically don't need delays, but keeping for consistency
