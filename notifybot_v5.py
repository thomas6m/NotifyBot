...
def send_email_from_folder(base: Path, attachment_subfolder: str, dry_run: bool, batch_size: int = 500, delay: float = 5.0, force: bool = False) -> None:
    ...
    if not force:
        log_and_print("info", "Ready to send emails. Press Enter to confirm or Ctrl+C to abort...")
        input()
...
def main():
    ...
    parser.add_argument("--base-folder", required=True, type=str, help="Base folder containing email resources.")
