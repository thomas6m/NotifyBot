#!/usr/bin/env python3
"""
NotifyBot: Automated email batch sender with single/multi mode support, filtering, logging, and dry-run.
...
Single Mode - Sends ONE email to MULTIPLE recipients:
    ...
    Optional: cc.txt, bcc.txt, attachment/, images/

Multi Mode - Sends MULTIPLE personalized emails:
    Required files: subject.txt, body.html, from.txt, approver.txt, filter.txt
    Optional: field.txt (for placeholder substitution), cc.txt, bcc.txt, attachment/, images/
...
def main():
    """Enhanced main function with single/multi mode support"""
    parser = argparse.ArgumentParser(description="Send batch emails with single/multi mode support.")
